...
public class Test2 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String FileName = "201608030-新-雨水管网过程模拟-芝加哥过程线-华家池002.txt";
...
//				{ 10, 11, 12, 5, 6, 7, 8, 9, -99, -99 } };
				// 管网路径数和路径节点号(-99表示空节点)
				int[][] Mroute = new int[][]{{0,1,2,3,4,5,6,7},{8,7,-99,-99,-99,-99,-99,-99},
...
//				0.013, 0.013, 0.013, 0.013, 0.013, 0.013 };
				...
				int[] I0 = new int[]{0, 1, 2, 3, 4, 5, 6, 7, 9};
